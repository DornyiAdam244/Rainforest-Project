        ...
        <article class="row mt-3">
          <div class="col-lg-8 col-12 order-lg-1 order-2">
            <ul class="list-group list-group-flush mt-lg-0 mt-4">
              <li class="list-group-item">🌍 Az esőerdők hatalmas mennyiségű oxigént termelnek, miközben elnyelik a szén-dioxidot. Nélkülük a levegőnk sokkal kevésbé lenne élhető.</li>
              <li class="list-group-item">💧 A trópusi erdők szabályozzák az éghajlatot és a víz körforgását. Segítenek abban, hogy legyen elegendő eső, ivóvíz és termékeny talaj.</li>
              <li class="list-group-item">🐾 Az esőerdők több millió állat- és növényfaj otthonai. Sok közülük sehol máshol a világon nem található meg.</li>
            </ul>
          </div>
